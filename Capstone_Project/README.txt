...
This project is split into two folders, Capstone & API Queries. The Capstone folder contains the README file, as well as the EDA/Modeling Jupyter Notebook and the Presentation Slides. The API Queries folder contains the Jupyter Notebook where I performed all my ballchasing.com API Queries.
