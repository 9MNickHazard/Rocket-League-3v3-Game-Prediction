...
This project in Sprint3 folder, then in API_Queries_Sprint3 & Capstone_Project_Sprint3 folders. The Capstone_Project_Sprint3 folder contains the README file, as well as the EDA/Modeling Jupyter Notebook and the Presentation Slides. The API_Queries_Sprint3 folder contains the Jupyter Notebook where I performed all my ballchasing.com API Queries.
